...
class_name HealthComponentPlayer
...
@export var action_reload : String = "play_char_reload_action"
@export var action_melee : String = "action_melee"
...
func _on_bullet_collision(obj: Node3D, damage: float, point: Vector3, collision_normal: Vector3) -> void:
	if obj.has_method("take_damage") and obj.is_in_group("Enemies"):
		obj.take_damage(damage * damage_multiplier)
